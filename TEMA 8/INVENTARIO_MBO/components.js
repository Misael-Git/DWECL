...
export const UI = {
    ...
    mostrarFormEditar() {
        document.getElementById('formEditarHide').style.display = 'flex';
    },

    ocultarFormEditar() {
        document.getElementById('formEditarHide').style.display = 'none';
        document.getElementById('formEditarHide').reset();
    },

    mostrarFormCrear() {
        document.getElementById('formCrearHide').style.display = 'flex';
    },

    ocultarFormCrear() {
        document.getElementById('formCrearHide').style.display = 'none';
        document.getElementById('formCrearHide').reset();
    }
};
